#! /bin/zsh
# Script to run joint WT + LKB1kd inference for MM_nonessential model.
...
python inference_lkb1kd.py -model MM_nonessential -compartment 2DG -free_params kOffAMP,kOffADP,kOffATP,kCaMKK,KmCaMKK,kLKB1,KmLKB1,alphaLKB1,kPP,KmPP,alphaPP,betaAMP -data_file ../../../AMPKARkey_data/HeLaAMPKAR3_260307_LKB1wt_2DG.npz -LKB1_KO_data_file ../../../AMPKARkey_data/HeLaAMPKAR3_260307_HeLaWT_2DG.npz -model_info_file ../models/MM_nonessential.json -metab_params_file ../models/metabolism_params_Coccimiglio.json -savedir ../../../results/param_est/ -nsamples 1000 -sampler Pathfinder -pcoeff 0.3 -icoeff 0.4 -rtol 1e-6 -atol 1e-6 -data_std_max 0.1 -num_paths_pathfinder 2 -jitter_pathfinder 0.01 -maxiter_pathfinder 1000 --compute_llike --sample_posterior

# Joint WT + LKB1kd Pathfinder — Iono data (calcium stimulus, requires CaMKK2 model + Ca²⁺ stress mechanism)
# python inference_lkb1kd.py -model MM_nonessential -compartment Iono -free_params kOffAMP,kOffADP,kOffATP,kCaMKK,KmCaMKK,kLKB1,KmLKB1,alphaLKB1,kPP,KmPP,alphaPP,betaAMP -data_file ../../../AMPKARkey_data/HeLaAMPKAR3_260307_LKB1wt_Iono.npz -LKB1_KO_data_file ../../../AMPKARkey_data/HeLaAMPKAR3_260307_LKB1kd_Iono.npz -model_info_file ../models/MM_nonessential.json -metab_params_file ../models/metabolism_params_Coccimiglio.json -savedir ../../../results/param_est/ -nsamples 1000 -sampler Pathfinder -pcoeff 0.3 -icoeff 0.4 -rtol 1e-6 -atol 1e-6 -data_std_max 0.1 -num_paths_pathfinder 2 -jitter_pathfinder 0.01 -maxiter_pathfinder 1000 --compute_llike --sample_posterior
