...
save_dir = '../../../results/param_est/figs/' + model + '/'

if not os.path.exists(save_dir):
    os.makedirs(save_dir)

# free parameters (exclude Deterministic trajectories)
...
with open('../models/MA_nonessential.json', 'r') as f:
...
fig.suptitle('Parameter Marginal Posteriors', fontsize=14, y=1.01)
fig.tight_layout()
